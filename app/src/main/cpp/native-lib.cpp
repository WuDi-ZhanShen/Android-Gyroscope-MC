...
Java_com_tile_tuoluoyi_GamePadNative_nativeInputEvent(JNIEnv *env, jclass clazz, jint x_value,jint y_value) {
...
//min 和 max必须不同
    ...
    uinput_dev.absmin[ABS_Z] = -32768;
    uinput_dev.absmax[ABS_Z] = 32768;
    uinput_dev.absmin[ABS_RZ] = -32768;
    uinput_dev.absmax[ABS_RZ] = 32768;
